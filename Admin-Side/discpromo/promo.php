...
<body>
    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <nav class="px-3 py-2 bg-white rounded shadow-sm">
                ...
                <h5 class="fw-bold mb-0 me-auto">Promos</h5>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Promo Information</h1>
    ...
    <?php require_once 'editpromo.php'; ?>
    ...
    <div class="modal fade" id="deleteHotelroomsModal" tabindex="-1" aria-labelledby="deleteHotelroomsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="deleteHotelroomsModalLabel">Delete Promo</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="promocode.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="promo_id" id="delete_id">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 style="position: absolute;"> Manage Promos </h3>
                        ...
                        <table class="table"  id="hotelrooms_table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="white-space: pre-wrap; max-width: 200px;">Promo Name </th>
                                    <th scope="col">Minimum Amount</th>
                                    <th scope="col" style="white-space: pre-wrap; max-width: 200px;">Discount Value</th>
                            ...
                            <?php
                                ...
                                ?>
                                        <tr>
                                            <td class="promo_id"><?php echo $row['id']; ?></td>
                                            <td><?php echo $row['promo_code']; ?></td>
                                            <td style="white-space: pre-wrap; max-width: 200px;"><?php echo $row['promo_name']; ?></td>
                                            <td><?php echo $row['minimum_amount']; ?></td>
                                            <td style="white-space: pre-wrap; max-width: 200px;"><?php echo $row['discount_value']; ?></td>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.delete_btn').click(function (e) { 
                ...
                var promo_id = $(this).closest('tr').find('.promo_id').text();
                // console.log(promo_id);
                $('#delete_id').val(promo_id);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, value) {
                            ...
                            $('#edit_promo_code').val(value['promo_code']);
                            $('#edit_promo_name').val(value['promo_name']);
                            $('#edit_minimum_amount').val(value['minimum_amount']);
                            $('#edit_discount_value').val(value['discount_value']);
