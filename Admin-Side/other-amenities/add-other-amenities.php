...
<body>
    <div class="home-section">
        ...
        <nav>
            ...
            <span class="text">Add New Amenity</span> 
        </nav> 
    </div>
<div class="container" id="formcontainer">
  <form action="add-other-amenities.php" method="post">
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <select id="amenity" name="amenity">
        <option value="None" <?php if(isset($_POST['amenity'])) { if ($_POST['amenity'] == 'None') echo ' selected="selected"'; } ?>> <--Please Select--></option>
        <option value="Aqua Park" <?php if(isset($_POST['amenity'])) { if ($_POST['amenity'] == 'Aqua Park') echo ' selected="selected"'; } ?>>Aqua Park</option>
        <option value="Tent" <?php if(isset($_POST['amenity'])) { if ($_POST['amenity'] == 'Tent') echo ' selected="selected"'; } ?>>Tent</option>
        <option value="Umbrella" <?php if(isset($_POST['amenity'])) { if ($_POST['amenity'] == 'Umbrella') echo ' selected="selected"'; } ?>>Umbrella</option>
      </select>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <select id="capacity" name="capacity">
        ...
        <option value="2 Persons Per Reservation" <?php if(isset($_POST['capacity'])) { if ($_POST['capacity'] == '2 Persons Per Reservation') echo ' selected="selected"'; } ?>>2 Persons Per Reservation</option>
