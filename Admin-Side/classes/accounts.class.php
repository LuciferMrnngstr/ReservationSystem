...
Class Accounts{
    ...
    function add(){
        $sql = "INSERT INTO staff_profile (photo, firstname, lastname, middle, contact, birthday, position, user_type, unit, street, barangay, city,  username, password, enter) VALUES 
        (:photo, :firstname, :lastname, :middle, :contact, :birthday, :position, :user_type, :unit, :street, :barangay, :city, :username, :password, :enter );";
        ...
        $query->bindParam(':username', $this->username);
        $query->bindParam(':password', $this->password);
        $query->bindParam(':enter', $this->enter);
    ...
    function edit(){
        $sql = "UPDATE staff_profile SET photo=:photo, firstname=:firstname, lastname=:lastname, middle=:middle, contact=:contact, birthday=:birthday, position=:position, user_type=:user_type, street=:street, barangay=:barangay, city=:city, username=:username, password=:password, enter=:enter WHERE id = :id;";
